...
class _ChatPageListState extends State<ChatPageList> {
  ...
  Future<void> fetchChatPageList() async {
    String token = widget.authToken;
    Map<String, dynamic> decodedToken = JwtDecoder.decode(token);
    int userId = decodedToken["id"];
    final response = await http.get(
      Uri.parse(
          'http://10.1.1.225:8002/web/dialogue?token=${widget.authToken}&page=0&user_id=$userId'),
      headers: {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: data_user!.entries.toList().reversed.map((entry) {
              String who =
                  entry.value['who'] == true ? widget.username : 'TalkBuddyAI';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('Message list', style: GoogleFonts.silkscreen(fontSize: 22)),
                      ...
                      GestureDetector(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            UserCardWidget(
                              title:
                                  '${data_user![data_user!.keys.toList()[0]]!['who'] == true ? widget.username : 'TalkBuddyAI'}',
                              subtitle:
